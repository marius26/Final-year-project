...
frame_a  = tools.imread( path / '/home/pi/Final-year-project/Python Scripts/OpenPiv/Photos/2-1.bmp' )
frame_b  = tools.imread( path / '/home/pi/Final-year-project/Python Scripts/OpenPiv/Photos/2-2.bmp' )
